...
<body>
    <header>
       ...
       <a href="login"><i class="fa fa-user-circle-o" style="float:right;font-size:56px;color:#dd7cd"></i></a></br></br></br>
        <div class="dropdown">
    ...
    <!--- TODO: UPDATE LINKS TO PAGES AS THEY ARE CREATED -->
    <div class="navbar">
